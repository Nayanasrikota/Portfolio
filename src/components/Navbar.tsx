...
export function Navbar() {
  ...
  return (
    ...
    >
      <div className={`flex items-center justify-between px-6 py-3 rounded-full transition-all duration-500 ${scrolled ? 'w-[95%] md:w-[800px] bg-black/50 backdrop-blur-xl border border-white/10 shadow-2xl shadow-black/50' : 'w-full max-w-7xl bg-transparent border-transparent'}`}>
